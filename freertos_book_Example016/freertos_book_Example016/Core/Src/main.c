...
{
  /* USER CODE BEGIN 1 */
	const char *pcTextForMain = "freertos_book_Example016 is running: Using a binary semaphore to synchronize a task with an interrupt\r\n\n";
...
/**
  ...
  * @retval None
  */
/* USER CODE END Header_vHandleTask */
void vHandlerTask(void * pvParameters)
{
